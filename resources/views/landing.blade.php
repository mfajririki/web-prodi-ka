        ...
        <div class="kingster-breadcrumbs-container kingster-container">
            <div class="kingster-breadcrumbs-item kingster-item-pdlr">
                <span property="itemListElement" typeof="ListItem">
                    <a property="item" typeof="WebPage" title="Beranda ." href="{{ url('') }}"
                        class="home"><span property="name">Beranda</span></a>
                                ...
                                <div
                                    ...
                                    <div class="gdlr-core-title-item-title-wrap clearfix">
                                        <h3 class="gdlr-core-title-item-title gdlr-core-skin-title "
                                            style="font-size: 27px ;font-weight: 600 ;letter-spacing: 0px ;text-transform: none ;color: #163269 ;">
                                            Program Studi Komputerisasi Akuntansi </h3>
                                    </div>
                                </div>
                            </div>

                            <!-- konten halaman utama. Komputerisasi Akuntansi -->
                            <div class="gdlr-core-pbf-element">
                                                        ...
                                                        <div class="gdlr-core-tab-item-wrap">
                                                            <div
                                                                ...
                                                                <div class="gdlr-core-tab-item-title  gdlr-core-active"
                                                                    data-tab-id="1">Tentang Prodi Komputerisasi Akuntansi
                                                                </div>
                                                                <div class="gdlr-core-tab-item-title " data-tab-id="2">Visi
                                                                </div>
                                                                <div class="gdlr-core-tab-item-title " data-tab-id="3">Misi
                                                                </div>
                                                            ...
                                                            <div class="gdlr-core-tab-item-content-wrap clearfix">
                                                                {{-- Tentang Prodi Komputerisasi Akuntansi --}}
                                                                <div class="gdlr-core-tab-item-content  gdlr-core-active"
                                                                    data-tab-id="1"
                                                                    style="background-color: #ffffff ;background-position: top right ;">
                                                                    <div
                                                                        class="gdlr-core-title-item gdlr-core-item-pdb clearfix  gdlr-core-left-align gdlr-core-title-item-caption-top">
                                                                        <div class="gdlr-core-title-item-title-wrap ">
                                                                            <h3 class="gdlr-core-title-item-title gdlr-core-skin-title "
                                                                                style="font-size: min(4vw, 22px);font-weight: 700 ;text-transform: none ;color: #314e85;">
                                                                                Sejarah Singkat Program Studi Komputerisasi
                                                                                Akuntansi<span
                                                                    ...
                                                                    <div class="text-justify">
                                                                        @foreach ($tentang as $tentang)
                                                                            <p style="font-size: min(3vw, 18px);">
                                                                                {!! $tentang->konten_tentang !!}</p>
                                                                        @endforeach
                                                                    </div>
                                                                </div>
                                                                <!-- Visi -->
                                    ...
                                    <div class="gdlr-core-widget-box-shortcode "
                                        ...
                                        <div class="gdlr-core-widget-box-shortcode-content">
                                            ...
                                            <h3 style="font-size: 20px; color: #fff; margin-bottom: 25px;">Universitas Bina
                                                Darma</h3>
                                            <p><span style="color: #3db166; font-size: 16px; font-weight: 600;">Program
                                                    Studi Komputerisasi Akuntansi</span>
                                                <br /> <span style="font-size: 15px;"><br />Jl. Jenderal A. Yani No. 3
                                                    Palembang<br />Sumatera Selatan, Indonesia</span>
                                            </p>
                                            <p><span style="font-size: 15px;">0711-515582<br />
                                                    universitas@binadarma.ac.id<br /> </span></p>
                                            <p><span style="font-size: 16px; color: #3db166;">Senin-Jumat 08:00 &#8211;
                                                    16:00 <br /> Sabtu 08:00 &#8211; 12:00</span></p> <span
                                                class="gdlr-core-space-shortcode" style="margin-top: 40px ;"></span>
                                            <h3 style="font-size: 20px; color: #fff; margin-bottom: 15px;">Social Info</h3>
                                            <div class="gdlr-core-social-network-item gdlr-core-item-pdb  gdlr-core-none-align"
                                                style="padding-bottom: 0px ;">
                                                <a href="https://api.whatsapp.com/send?phone=628117155582&text=Saya%20Ingin%20info%20Mahasiswa%20Baru%20Universitas%20Bina%20Darma"
                                                    target="_blank" class="gdlr-core-social-network-icon" title="whatsapp"
                                                    style="color: #3db166 ;"><i class="fa fa-whatsapp"></i></a>
                                                <a href="https://www.facebook.com/UBDPalembang/" target="_blank"
                                                    class="gdlr-core-social-network-icon" title="facebook"
                                                    style="color: #3db166 ;"><i class="fa fa-facebook"></i></a>
                                                <a href="https://www.instagram.com/ubd_palembang/" target="_blank"
                                                    class="gdlr-core-social-network-icon" title="instagram"
                                                    style="color: #3db166 ;"><i class="fa fa-instagram"></i></a>
                                                <a href="https://www.youtube.com/BINADARMATV" target="_blank"
                                                    class="gdlr-core-social-network-icon" title="youtube"
                                                    style="color: #3db166 ;"><i class="fa fa-youtube"></i></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="gdlr-core-pbf-element">
                                        <div class="gdlr-core-text-box-item gdlr-core-item-pdlr gdlr-core-item-pdb gdlr-core-left-align"
                                            ...
                                            <div class="gdlr-core-text-box-item-content"
                                                ...
                                                <div class="gdlr-core-blockquote-item-quote gdlr-core-quote-font"
                                                    style="font-size: 170px ; margin-top: -120px">“</div>
                                                @foreach ($profile_kaprodi as $kaprodi)
                                                    ...
                                                    <p>
                                                        ...
                                                        <br>Ketua Program Studi Komputerisasi Akuntansi
                                                    </p>
                                                @endforeach
                                            </div>
                                        </div>
                                    ...
                                    <div class="gdlr-core-pbf-element">
                                        <div class="gdlr-core-button-item gdlr-core-item-pdlr gdlr-core-item-pdb gdlr-core-left-align"
                                            ...
                                            <a class="gdlr-core-button  gdlr-core-button-solid gdlr-core-left-align gdlr-core-button-no-border"
                                                href="https://pmb.binadarma.ac.id" target="_blank"
                                                style="font-size: 14px ;font-weight: 700 ;letter-spacing: 0px ;padding: 13px 26px 16px 30px;text-transform: none ;margin: 0px 10px 10px 0px;border-radius: 2px;-moz-border-radius: 2px;-webkit-border-radius: 2px;background: #d61b23 ;"><span
                                                    class="gdlr-core-content">Informasi Pendaftaran</span><i
